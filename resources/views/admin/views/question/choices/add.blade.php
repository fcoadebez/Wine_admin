				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-divider">
							Ajout d'un choix pour cette étape
						...
						<div class="panel-body">
							...
							<br/>
							<form method="POST" action="{{ URL::to('/admin/configurator/'.$idQuestion.'/choice/add') }}" enctype="multipart/form-data">
									...
									<div class="col-12 form-group row" style="padding: 0;">
										...
										<div class="col-6">
											<div class="switch-button switch-button-danger">
												<input type="checkbox" name="question_next_end" id="question_next_end">
												<span>
										...
										<div class="col-6">
											<select name="question_next_id" class="form-control custom-select" required>
												...
												@foreach($questions as $q)
													<option value="{{$q->id}}">{{$q->order}} : {{$q->name}}</option>
												@endforeach
											</select>
										</div>
									</div>
