...
@section('html_title')Ajout | Utilisateurs | Paramètres | Administration @endsection
@section('html_body')id="settings_user_add"@endsection
@section('html_js')
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading panel-heading-divider">
							...
							<span class="panel-subtitle">Entrer les champs requis pour créer le compte utilisateur.</span>
						</div>
						<div class="panel-body">
							...
							<br/>
							<form method="POST" action="{{ URL::to('/admin/settings/user/add') }}">
